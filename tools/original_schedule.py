...
from fcos_core.modeling.detector.labelenc_step1_network import LabelEncStep1Network
...
def do_train(
    ...
    for iteration, (images, targets, _) in enumerate(data_loader, start_iter):
        ...
        if iteration <= cfg.MODEL.LABELENC.DISTANCE_LOSS_WARMUP_ITERS:
            loss_dict = model(images, targets, distance_loss_weight=0)
        else:
        ...
        if iteration <= cfg.MODEL.LABELENC.DISTANCE_LOSS_WARMUP_ITERS:
            for p in model.module.feature_adapt.parameters():
                p.grad = None
...
def main():
    ...
    cfg.MODEL.LABELENC.DISTANCE_LOSS_WARMUP_ITERS = 40000
    cfg.SOLVER.STEPS = (80000, 105000)
    ...
    if not args.distributed or dist.get_rank() == 0:
        ...
        saved_weights = {'label_encoding_function': label_encoding_function,
                         'rpn': rpn}
